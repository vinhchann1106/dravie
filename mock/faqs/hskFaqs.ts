export const hskFaqs = [
  {
    title: "Học tiếng Trung HSK theo lộ trình như thế nào?",
    content: `1. Có nhất định phải theo lộ trình học DraVie đưa ra không?
Lộ trình học cùng Study plan chi tiết đến từng ngày là lộ trình học TỐI ƯU NHẤT, HIỆU QUẢ NHẤT giúp bạn chinh phục được đúng mục tiêu đã đề ra. Tuy nhiên, các bạn hoàn toàn có thể chủ động sắp xếp và thay đổi thời gian để có lộ trình học HSK và luyện tập phù hợp với kế hoạch riêng.

2. Có cần dùng thêm tài liệu ngoài khi học HSK cùng DraVie không?
...
- Ngoài học chương trình của từng khóa, bạn có thể sử dụng các gói dịch vụ để luyện tập thêm đầy đủ 4 kỹ năng: Listening, Speaking, Reading, Writing — luyện làm đề hiệu quả cùng trên một nền tảng Dravie.com.`,
  ...
  {
    title: "Thời gian sử dụng Lộ Trình học HSK",
    content: `Mỗi Chặng học HSK bạn được sử dụng lên tới 12 tháng kể từ ngày hoàn thành đăng ký học.
Thời gian sử dụng Lộ Trình học HSK của bạn bằng tổng thời gian của từng Chặng.
...
➡ Bắt đầu học ngay để đạt mục tiêu sớm. Đã quyết tâm Đăng Ký, Hãy quyết tâm Học liền!`,
  ...
  {
    title: "Học HSK online có được tương tác với giáo viên không?",
